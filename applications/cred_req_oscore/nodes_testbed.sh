# NOTE: Hardware addresses in uppercase!
declare -A NODES=(
    ...
    [320]="A6:6E:51:CC:87:AD:3D:23 fe80::a46e:51cc:87ad:3d23"
    [0]=":: ::"
)
...
declare -A CONFIG=(
    [site]="grenoble"
    [board]="iotlab-m3"
    [global_prefix]="2001:660:5307:3101"
    [global_prefix_length]="64"
    [experiment_id]="278161"
    [experiment_name]="cred_req_oscore"
    [board_prefix]="m3"
)
